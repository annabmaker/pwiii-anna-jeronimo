...
<body>
  <div
    ...
    <div>
      <div class="text-xl font-medium text-black dark:text-white">Aula João</div>
      ...
      <div class="grid grid-flow-col grid-rows-3 gap-4">
        ...
        <div class="row-span-2 row-end-3 font-serif border-4 bg-indigo-500 bg-clip-border p-3">Vindo!</div>
        <div class="row-start-1 row-end-4 font-serif border-4 bg-indigo-500 bg-clip-border p-3"">Ao meu projeto!</div>
      </div>
    </div>
